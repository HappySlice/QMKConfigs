...
[_QWERTY] = { /*QWERTY*/
	{KC_GRV,    KC_1,      KC_2,    KC_3,    KC_4,    KC_5,    KC_LEFT,   KC_UP,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,       KC_DEL },
	{KC_TAB,    KC_Q,      KC_W,    KC_E,    KC_R,    KC_T,    KC_RGHT,   KC_DOWN,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,       KC_BSPC },
	{KC_ESC,    KC_A,      KC_S,    KC_D,    KC_F,    KC_G,    KC_LGUI,   XXXXXXX,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,    KC_QUOT },
	{KC_LSFT,   KC_Z,      KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX,   XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_LSFT  },
	{XXXXXXX,   XXXXXXX,   KC_LCTL, LOWER,  KC_LGUI,  KC_SPC,  XXXXXXX,   XXXXXXX,   KC_ENT,  KC_END,   RAISE, KC_LALT, XXXXXXX,      XXXXXXX}
...
[_LOWER] = {/*LOWER*/
  ...
  {RESET,   KC_EXLM, KC_AT,   KC_HASH, KC_DLR, KC_PERC,  XXXXXXX,   XXXXXXX, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL},
  {KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX,   XXXXXXX, KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE},
  {KC_LSFT, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  XXXXXXX,   XXXXXXX, KC_F12,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LSFT},
